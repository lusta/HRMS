		...
		success: function(data){
	        ...
	        "aoColumns": [	                   	                      
	                  ...
	                  "fnRowCallback": function (nRow, aData, iDisplayIndex, iDisplayIndexFull) { 
	       	           ...
	       	           $('td:eq(8)', nRow).html('<input type="submit" value="Details" onclick="doUpdate('+iDisplayIndex+');" class="mws-button green small"> <input type="button" class="mws-button red small" value="Delete" onclick="doDelete('+aData["empNumber"]+');"/><br/>');
